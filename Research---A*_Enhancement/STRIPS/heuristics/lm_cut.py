...
class LmCutHeuristic:
    ...
    def __call__(self, node):
        ...
        if self.dead_end:
            ...
            # # slowdown - version 1
            # if heuristic_value > 20:
            #     return heuristic_value - 4
            # elif 15 < heuristic_value <= 20:
            #     return heuristic_value - 3
            # elif 10 < heuristic_value <= 15:
            #     return heuristic_value - 2
            # elif 7 < heuristic_value <= 10:
            #     return heuristic_value - 1
            # elif 5 < heuristic_value <= 7:
            #     return heuristic_value - 1
            # else:
            ...
            #     return int(heuristic_value * 0.95)
            # else:
            #     return heuristic_value

            # # slowdown - version 3
            # if heuristic_value > 10:
            #     return int(heuristic_value * 0.90)
            # else:
            #     return heuristic_value
