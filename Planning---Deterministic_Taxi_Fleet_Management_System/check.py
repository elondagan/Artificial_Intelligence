...
def check_problem(p, search_method, timeout):
    """ Constructs a problem and solves it using the given 
    search_method with the given timeout. Returns a tuple of (
    solution length, solution time, solution)"""
...
def solve_problems(problems):
    ...
    for problem in problems:
        try:
            p = manager.create_taxi_problem(problem)
        except Exception as e:
